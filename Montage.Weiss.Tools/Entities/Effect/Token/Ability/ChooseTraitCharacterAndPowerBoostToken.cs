...
/// Supports an optional "other" qualifier and singular/plural pronoun selection.
/// </summary>
/// <remarks>
/// <para><b>Expected Input:</b> <c>あなたは他の自分の《NIKKE》のキャラを1枚選び、そのターン中、パワーを＋2000。</c></para>
/// <para><b>Regex:</b> ^あなたは(?:他の)?自分の《(.+?)》のキャラを(\d+)枚選び、そのターン中、パワーを＋(\d+)(?:\.|,|、|。)?</para>
...
///   <item><description>Group 3: Power boost value (e.g., "2000")</description></item>
/// </list>
/// <para><b>Output:</b> <c>choose 1 of your other &lt;&lt;NIKKE&gt;&gt; characters, and that character gets +2000 power until end of turn</c></para>
/// </remarks>
