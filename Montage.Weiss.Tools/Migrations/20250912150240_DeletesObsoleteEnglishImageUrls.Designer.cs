...
namespace Montage.Weiss.Tools.Migrations
{
    ...
    [Migration("20250912150240_DeletesObsoleteEnglishImageUrls")]
    partial class DeletesObsoleteEnglishImageUrls
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Montage.Card.API.Entities.Impls.ActivityLog", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            LogID = 6,
                            Activity = 1,
                            DateAdded = new DateTime(2024, 10, 22, 0, 45, 56, 150, DateTimeKind.Local).AddTicks(6113),
                            IsDone = false,
                        ...
                        new
                        {
                            LogID = 7,
                            Activity = 1,
                            DateAdded = new DateTime(2025, 9, 12, 22, 57, 46, 681, DateTimeKind.Local).AddTicks(3155),
                            IsDone = false,
